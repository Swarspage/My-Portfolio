    ...
    <>
      <div className="max-w-2xl mx-auto px-4 sm:px-8 md:px-12">
        ...
        <div className="w-full mt-3">
          <a
            ...
            className="block"
          >
            <div className="h-40 flex border border-gray-700 bg-none hover:bg-gray-950 rounded-2xl truncate w-full mt-5">
              <div className="h-full overflow-hidden w-[30%]">
                <img
              ...
              <div className="flex flex-col justify-center px-5 font-[Quicksand] w-[70%]">
        ...
        <div className="w-full mt-3">
          ...
          >
            <div className="h-40 flex border border-gray-700 bg-none hover:bg-gray-950 rounded-2xl truncate w-full mt-5">
              ...
              <div className="flex flex-col justify-center px-5 font-[Quicksand] w-[70%]">
                <p className="text-[#fafafa] text-xl font-semibold">Vayu</p>
                <p className="text-gray-400 text-sm break-words whitespace-normal">
        ...
        <div className="flex items-center justify-center text-center h-40 w-full text-gray-400 font-[Quicksand]">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-8 md:px-12">
        <div className=" border-t border-gray-700 font-[Quicksand] flex flex-col text-[#fafafa] gap-3">
          <h1 className=" my-8 font-[doto] font-bold tracking-wider text-[26px] leading-8 text-[#b42323]">
            Swar.dev
          </h1>
          <div className="">
